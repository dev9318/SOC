...
while(1):
    ...
    if(n<5):
        for i in range(1280000):
            ...
            b1= randint(0,lens[x][0]-1)
            c1= randint(0,lens[x][1]-1)
            if((ab[x][b][c] or ab[x][b1][c1])and n>0):
                for i in range(n):
                    a[n-i][x][b][c]= a[n-i][x][b][c]+a[n-i][x][b1][c1]
                    a[n-i][x][b1][c1]= a[n-i][x][b][c]-a[n-i][x][b1][c1]
                    a[n-i][x][b][c]= a[n-i][x][b][c]-a[n-i][x][b1][c1]
            ab[x][b][c]= ab[x][b][c]+ab[x][b1][c1]
            ab[x][b1][c1]= ab[x][b][c]-ab[x][b1][c1]
            ab[x][b][c]= ab[x][b][c]-ab[x][b1][c1]
    else:
        for i in range(3200):
            x= randint(0,28)
